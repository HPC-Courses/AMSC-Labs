...
int main() {
  ...
  // TODO: define a vector of SparseMatrix with the two classes we have defined

  // TODO: loop over every matrix and test and benckmark it
  for (/*TODO: loop over matrices*/) {
